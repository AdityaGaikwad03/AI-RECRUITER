...
| AI | Smart Assistant (with local fallbacks) |
| Auth | JWT + bcrypt |
...
cd backend
npm install
# Optional: add your API key for enhanced features
cp .env.example .env
# Edit .env: AI_API_KEY=your_api_key_here
node server.js
