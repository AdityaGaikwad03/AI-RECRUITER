    ...
    <div className={styles.chat}>
      <div className={styles.header}>
        <div className={styles.headerLeft}>
          ...
          <div>
            <p className={styles.aiName}>HireAI Assistant</p>
            <p className={styles.aiStatus}><span className={styles.statusDot} /> Online · AI-powered</p>
          </div>
        </div>
      ...
      <div className={styles.inputArea}>
        <textarea
          className={`${styles.inputBox} input input-ai`}
          value={input}
          onChange={e => setInput(e.target.value)}
          onKeyDown={handleKey}
          placeholder="Type naturally... AI will structure it"
          rows={2}
        />
