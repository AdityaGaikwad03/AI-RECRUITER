        ...
        <div className={styles.mainInner}>
          ...
          <div className={styles.sectionHeader}>
            <div>
              ...
              <p className={styles.sectionSub}>Auto-saved as you type · <span style={{ color: 'var(--ai)' }}>AI-assisted</span></p>
            </div>
              ...
              <div className={styles.formCol}>
                ...
                <div className={styles.field}>
                  ...
                  <div style={{ display: 'flex', gap: 8 }}>
                    ...
                    <button onClick={fetchRoleRecs} disabled={aiLoading} className="btn btn-ai btn-sm">AI Suggest</button>
                  </div>
                  {recommendedRoles.length > 0 && (
                    <div className={styles.aiSuggestions}>
                      <p className={styles.suggestLabel}><span className="ai-badge">Smart Recommended</span></p>
            ...
            <div className={styles.formGrid}>
              <div className={styles.formCol}>
                <div className={styles.existingList}>
                  {profile.skills.length === 0 && <p className={styles.emptyHint}>No skills yet. Add some below or use AI suggestions →</p>}
                ...
                <div style={{ display: 'flex', gap: 8, marginTop: 8 }}>
                  <button onClick={fetchSkillSuggestions} disabled={aiLoading} className="btn btn-ai btn-sm">
                    {aiLoading ? '...' : '✦ AI Suggest Skills'}
                  </button>
                </div>
                {suggestedSkills.length > 0 && (
                  <div className={styles.aiSuggestions}>
                    <p className={styles.suggestLabel}><span className="ai-badge">Smart Suggestions</span> · Click to add</p>
            ...
            <div className={styles.formGrid}>
              <div className={styles.formCol}>
                <div className={styles.aiInputBox}>
                  <label className="label"><span className="ai-badge">Smart Parse</span> Describe experience naturally</label>
                  <textarea className="input input-ai" value={expText} onChange={e => setExpText(e.target.value)} placeholder={'e.g. "I worked at Amazon for 2 years as a backend engineer building microservices with Node.js and AWS. I led a team of 4 and improved API response time by 40%."'} rows={4} style={{ resize: 'none' }} />
                  <button onClick={parseExperience} disabled={parsingExp || !expText.trim()} className="btn btn-ai" style={{ marginTop: 10 }}>
                    {parsingExp ? '✦ Parsing...' : '✦ AI Structure This'}
                  </button>
                </div>
                <div className={styles.existingList} style={{ marginTop: 20 }}>
                  {profile.experience.length === 0 && <p className={styles.emptyHint}>No experience added. Describe it above and let AI structure it!</p>}
            ...
            <div className={styles.formGrid}>
              <div className={styles.formCol}>
                <div className={styles.aiInputBox}>
                  ...
                  <p style={{ fontSize: 12, color: 'var(--text3)', marginTop: 8 }}>✦ AI generates summaries based on your skills, experience, and target roles</p>
                </div>
