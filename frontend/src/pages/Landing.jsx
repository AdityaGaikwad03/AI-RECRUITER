...
const features = [
  { icon: '🧠', title: 'Smart Profile Builder', desc: 'Just talk — our assistant structures your experience, skills, and achievements automatically.', badge: 'Smart' },
  ...
  { icon: '🎯', title: 'Smart Matching', desc: 'Role recommendations are data-driven and skill-aware, not keyword stuffing.', badge: 'Intelligent' },
    ...
    <div className={styles.page}>
      ...
      <header className={styles.header}>
        <div className={styles.headerInner}>
          <div className={styles.logo}><span className={styles.logoMark}>✦</span> HireSmart</div>
        ...
        <div className="container">
          <div className={styles.heroContent}>
            <div className={styles.heroBadge}>
              ...
              Powered by Smart Assistant · No Resume Upload Required
            </div>
      ...
      <footer className={styles.footer}>
        <div className="container">
          <p>✦ HireSmart — Smart Recruitment Platform · Built for the Internship Assignment</p>
        </div>
      </footer>
    </div>
  );
